...
import TreeVisualization from "@/components/merge/tree-visualization";
import CodeSnippet from "@/components/merge/codeBlock";
...
<TreeVisualization
	...
	title="Divide Phase - Breaking Down the Array"
	subtitle="The array is recursively divided until each subarray contains a single element"
/>

The algorithm recursively divides the array into smaller subarrays:

- Level 0: `[38, 27, 43, 3, 9, 82, 10]` (original array)
- Level 1: `[38, 27, 43, 3]` and `[9, 82, 10]`
- Level 2: `[38, 27]`, `[43, 3]`, `[9]`, and `[82, 10]`
- Level 3: `[38]`, `[27]`, `[43]`, `[3]`, `[82]`, and `[10]`

### Merging Phase

<TreeVisualization
	data={[3, 9, 10, 27, 38, 43, 82]}
	title="Merge Phase - Combining Sorted Subarrays"
	subtitle="Sorted subarrays are merged back together to form the final sorted array"
/>
...
To reduce space complexity, various in-place merge sort implementations exist, though they typically increase time complexity to O(n log² n).
